...
typedef union { vector_entry __fun; void * __ptr; } intvec_elem;
    ...
    #define DEFAULT_VECTOR  __boot_exception
        ...
        intvec_elem ram_vector[128] @ ".vectors_ram" =
    #elif defined(__CC_ARM) || defined(__GNUC__)
        __attribute__((section(".vectors_ram"))) vector_entry ram_vector[128] __attribute__((used)) =
    #else /* CodeWarrior compiler assumed */
         ...
         * VBR+0x408 address
         */
        __declspec(vectors_ram) vector_entry ram_vector[128 + 6] =
    #endif /* CodeWarrior compiler assumed */
    {
...
#elif defined(__CC_ARM) || defined(__GNUC__)
    __attribute__((section(".vectors_rom"))) const vector_entry __vector_table[128] __attribute__((used)) =
#else /* CodeWarrior compiler assumed */
