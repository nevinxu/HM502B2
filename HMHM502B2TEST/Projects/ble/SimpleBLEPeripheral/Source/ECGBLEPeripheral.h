...
#define ECG_PERIODIC_EVT                                  0x0004
#define BATT_PERIODIC_EVT                                 0x0008
#define CONNECT1_ECG_EVT                                  0x0010
#define CONNECT2_ECG_EVT                                  0x0020
#define DISCONNECT_ECG_EVT                                0x0040
#define TEST_EVT                                          0x0080
   
   
#define IDValueStoreFlashPage                     125
#define IDValueStoreFlashStartAddr                 0xFA00
